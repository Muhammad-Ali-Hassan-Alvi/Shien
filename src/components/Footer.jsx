...
export default function Footer() {
    ...
    return (
        <footer className="relative bg-white/60 backdrop-blur-xl border-t border-white/40 pt-24 pb-12 overflow-hidden">
            ...
            <h1 className="absolute bottom-[-5%] left-1/2 -translate-x-1/2 text-[12vw] font-black text-black/[0.03] pointer-events-none select-none tracking-[0.08em] leading-none whitespace-nowrap z-0 uppercase">
                Islamabad Mart
            </h1>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20 border-t border-gray-200 pt-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3 text-sm text-gray-500 font-medium">
                            <li><Link href="/help-center" className="hover:text-black transition-colors">Help Center</Link></li>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3 text-sm text-gray-500 font-medium">
                            <li><Link href="/legal/privacy" className="hover:text-black transition-colors">Privacy Policy</Link></li>
                            <li><Link href="/legal/terms" className="hover:text-black transition-colors">Terms of Service</Link></li>
                            <li><Link href="/legal/cookie-policy" className="hover:text-black transition-colors">Cookie Policy</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-gray-200">
                    <p className="text-xs text-gray-400 font-medium">© {year} Islamabad Mart. All rights reserved.</p>
